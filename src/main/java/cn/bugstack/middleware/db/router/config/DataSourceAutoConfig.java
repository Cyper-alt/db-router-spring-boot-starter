...
import cn.bugstack.middleware.db.router.DBJoinPoint;
...
import cn.bugstack.middleware.db.router.strategy.impl.DBRouterStrategyConsistentHash;
...
public class DataSourceAutoConfig implements EnvironmentAware {
    ...
    @Bean(name = "db-point")
    @ConditionalOnMissingBean
    public DBJoinPoint db_point() {
        return new DBJoinPoint();
    }
    ...
    @Bean
    @ConditionalOnProperty(name = "mini-db-router.jdbc.datasource.db-router-strategy", havingValue = "HashCode",matchIfMissing = true)
    public IDBRouterStrategy dbRouterStrategyHashCode(DBRouterConfig dbRouterConfig) {
        return new DBRouterStrategyHashCode(dbRouterConfig);
    }

    @Bean
    @ConditionalOnProperty(name = "mini-db-router.jdbc.datasource.db-router-strategy", havingValue = "ConsistentHash")
    public IDBRouterStrategy dbRouterStrategyConsistentHash(DBRouterConfig dbRouterConfig) {
